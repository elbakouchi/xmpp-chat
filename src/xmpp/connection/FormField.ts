...
class Option2 {
   public static fromXML(optionElement:any) {
...
export default class FormField {
   ...
   public static fromXML(fieldElement:any) {
      return new FormField({
         ...
         values: fieldElement.find('>value').map((index:any, element:any) => $(element).text()).get(), // MAY
         options: fieldElement.find('option').map((index:any, element:any) => Option2.fromXML($(element))).get() // MAY
      })
   }

   public static fromHTML(formElement:any) {
