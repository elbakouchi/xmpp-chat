import Storage from '@/xmpp/Storage'
...
export default class RoleAllocator {
   ...
   private resolveTimeout:any;

   private observationTimeout:any;

   private claimTimeout:any;

   private masterResolves = [];

   private slaveResolves = [];

   private slaveValue:any;

   private masterValue:any;
   ...
   private thereIsAnotherPotentialMaster(value:any) {
